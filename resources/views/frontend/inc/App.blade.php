...
<head>
    ...
    <link rel="preload" href="{{asset('assets/frontend/vendor/fontawesome-free/webfonts/fa-brands-400.woff2')}}" as="font" type="font/woff2"
          crossorigin="anonymous">
    <link rel="preload" href="{{asset('assets/frontend/fonts/wolmart87d5.ttf.png')}}09e')}}" as="font" type="font/ttf" crossorigin="anonymous">
        ...
        <div class="header-top">
            <div class="container">
                ...
                <div class="header-right">
                    ...
                    <div class="dropdown">
                        <a href="#"><img src="{{asset('assets/frontend/images/flags/eng.png')}}" alt="ENG Flag" width="14"
                                        ...
                                        <ul class="megamenu">
                                            ...
                                            <li>
                                                <div class="menu-banner banner-fixed menu-banner3">
                                                    <figure>
                                                        <img src="{{asset('assets/frontend/images/menu/banner-3.jpg')}}" alt="Menu Banner"
                                        ...
                                        <ul class="megamenu">
                                            ...
                                            <li>
                                                <div class="menu-banner banner-fixed menu-banner4">
                                                    <figure>
                                                        <img src="{{asset('assets/frontend/images/menu/banner-4.jpg')}}" alt="Menu Banner"
